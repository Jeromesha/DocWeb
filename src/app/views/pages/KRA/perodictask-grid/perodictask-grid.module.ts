...
import { PerodictaskAddComponent } from './perodictask-add/perodictask-add.component';
...
const routes: Routes = [
  {
    path: '',
    component: PerodictaskGridComponent
  },
  {
    path: ":id/:actionInfo",
    component: PerodictaskAddComponent
  },
];

@NgModule({
  declarations: [
    PerodictaskGridComponent,
    PerodictaskAddComponent
  ],
  providers: [
    DatePipe,
    ExcelService,
...
export class PerodictaskGridModule { }
